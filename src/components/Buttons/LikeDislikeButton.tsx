  ...
  return (
    <div className="flex-end isolate inline-flex rounded-md shadow-sm">
      <button
        ...
        className={`focus group relative inline-flex items-center rounded-l-md px-2 py-2 ring-1 ring-inset ring-gray-300 focus:z-10 ${userChoice.like ? "group bg-primary-600 text-white hover:text-gray-900 group-hover:stroke-gray-900" : "group bg-white text-gray-600 hover:text-primary-600 group-hover:stroke-primary-600"}`}
      >
        <ThumbsUp
          className={`group h-4 w-4 shrink-0 ${userChoice.like ? "group fill-white group-hover:stroke-gray-900" : "group stroke-gray-600 group-hover:stroke-primary-600"}`}
        />
